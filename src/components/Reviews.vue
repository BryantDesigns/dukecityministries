  ...
  <div class="relative isolate bg-white pb-32 pt-24 sm:pt-32">
    ...
    <div class="mx-auto max-w-7xl px-6 lg:px-8">
      ...
      <div class="mx-auto mt-16 grid max-w-2xl grid-cols-1 grid-rows-1 gap-8 text-sm leading-6 text-gray-900 sm:mt-20 sm:grid-cols-2 xl:mx-0 xl:max-w-none xl:grid-flow-col xl:grid-cols-4">
        ...
        <div v-for="(columnGroup, columnGroupIdx) in testimonialsArray" :key="columnGroupIdx" class="space-y-8 xl:contents xl:space-y-0">
          <div v-for="(column, columnIdx) in columnGroup" :key="columnIdx" :class="[(columnGroupIdx === 0 && columnIdx === 0) || (columnGroupIdx === testimonialsArray.length - 1 && columnIdx === columnGroup.length - 1) ? 'xl:row-span-2' : 'xl:row-start-1', 'space-y-8']">
...
console.log("here",props.testimonialsArray);
console.log("here",props.featuredTestimonial);
</script> 